...
static const unsigned int gappx     = 9;        /* Gap pixels between borders */
/* tagging */
...
static const char *sclock[]         = { "i3lock", "-c", "000000", NULL };
...
static Key keys[] = {
    ...
    { MODKEY|ShiftMask,             XK_l,      spawn,          {.v = sclock } },
	TAGKEYS(                        XK_1,                      0)
	TAGKEYS(                        XK_2,                      1)
	TAGKEYS(                        XK_3,                      2)
	TAGKEYS(                        XK_4,                      3)
